...
export const questionsCategoriesLabels: Record<QuestionCategory, string> = {
  general: "Общие вопросы",
  relations: "Дружба и общение",
  loveAndRomance: "Любовь и романтика",
  career: "Карьера и достижения",
  travel: "Путешествия",
  childhood: "Детство",
  tasks: "Задания",
};
...
const relationsQuestions: string[] = [
...
const loveAndRomanceQuestions: string[] = [
...
const childhoodQuestions: string[] = [
...
export const QUESTIONS: Question[] = [
  ...generalQuestions.map((question, index) => ({
    id: `general-${index}`,
    text: question,
    type: "general" as QuestionCategory,
  })),
  ...relationsQuestions.map((question, index) => ({
    id: `relations-${index}`,
    text: question,
    type: "relations" as QuestionCategory,
  })),
  ...loveAndRomanceQuestions.map((question, index) => ({
    id: `love-and-romance-${index}`,
    text: question,
    type: "loveAndRomance" as QuestionCategory,
  })),
  ...careerQuestions.map((question, index) => ({
    id: `career-${index}`,
    text: question,
    type: "career" as QuestionCategory,
  })),
  ...travelQuestions.map((question, index) => ({
    id: `travel-${index}`,
    text: question,
    type: "travel" as QuestionCategory,
  })),
  ...childhoodQuestions.map((question, index) => ({
    id: `childhood-${index}`,
    text: question,
    type: "childhood" as QuestionCategory,
  })),
  ...tasksQuestions.map((question, index) => ({
    id: `tasks-${index}`,
    text: question,
